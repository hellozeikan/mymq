...
func NewChannel(topicName string, channelName string, options *MqOptions, deleteCallback func(*Channel)) *Channel {
...
func (c *Channel) MemoryChan() chan *Message {
...
func (c *Channel) StartInFlightTimeout(msg *Message, client Consumer) error {
